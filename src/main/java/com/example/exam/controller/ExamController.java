...
public class ExamController {
    ...
    @GetMapping("/{examId}")
    public String getExamPage(@PathVariable Long examId, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (examResultRepository.existsByStudentAndExam(student, exam)) {
            redirectAttributes.addFlashAttribute("errorMessage", "You have already completed this exam.");
            return "redirect:/student/dashboard"; // Redirect correctly
        }
